...
/* Instruments */
import {verifyNameIsUnique} from './thunks'
...
export const activeUserSlice = createSlice({
    ...
    extraReducers: (builder) => {
        builder
            .addCase(verifyNameIsUnique.pending, (state) => {
                state.lichessUsername = null
            })
            .addCase(verifyNameIsUnique.fulfilled, (state, action) => {
                state.lichessUsername = action.payload || null
            })
    },
})
